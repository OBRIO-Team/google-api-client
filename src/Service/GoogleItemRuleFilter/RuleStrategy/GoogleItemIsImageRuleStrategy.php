...
/**
 * Class GoogleItemIsImageRuleStrategy
 * @package ObrioTeam\GoogleApiClient\Service\GoogleItemRuleFilter\RuleStrategy
 */
class GoogleItemIsImageRuleStrategy implements GoogleItemRuleStrategyInterface
{
    ...
    {
        return 'image/png' === $this->file->getMimeType();
    }
